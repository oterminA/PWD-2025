...
<body>
    <form action="./action.php" method="post" enctype="multipart/form-data" onsubmit="return validar()"> <!-- con el enctype estoy llenando al $_files de la informacion que obtenga de acá -->
