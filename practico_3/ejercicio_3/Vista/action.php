...
if ($_POST) { //el action funciona como un identificador para saber qué acción ejecutar en el controller, o sea que si lo que está hidden coincide, hago todo esto
    include_once('../Control/controlPeliculas.php');//esto es para poder usar la funcion del controlador, acá mando información para que sea resuelta
    ...
    $dirFisica = 'C:\\xampp\\htdocs\\prog_web_dinamica\\u1\\practico_3\\ejercicio_3\\Vista\\archivosSubidos/'; //barra invertida doble. Esta es la direccion FISICA de donde se va a guardar el archivo 
    ...
    include_once('./mensajePeliculas.php'); //para pasarle el resultado a ese php, aunque bien podria seer el mismo index.phps
}
